...
/*   Updated: 2023/12/19 00:33:30 by yhwang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	is_in_shadow(t_vec3 P,
			t_vec3 light_direction, float light_distance, t_scene scene)
{
	int		i;
	t_ray	shadow_ray;
	float	t[2];
